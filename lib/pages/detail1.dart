...
import 'package:qwe/profile/utils.dart';

class DetailPagee extends StatefulWidget {
  const DetailPagee({Key? key}) : super(key: key);

  @override
  State<DetailPagee> createState() => _DetailPageeState();
}

class _DetailPageeState extends State<DetailPagee> {
  @override
